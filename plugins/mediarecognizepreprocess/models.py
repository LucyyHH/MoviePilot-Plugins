...
class RuleDef:
    ...
    title_group: Union[str, List[str]] = "title"
    year_group: Optional[Union[str, List[str]]] = "year"
    season_group: Optional[Union[str, List[str]]] = None
    episode_group: Optional[Union[str, List[str]]] = None
    strip_patterns: List[str] = field(default_factory=list)
